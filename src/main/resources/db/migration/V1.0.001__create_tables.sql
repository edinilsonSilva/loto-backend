...
CREATE TABLE public.shares_files
(
    id           SERIAL            NOT NULL,
    created_at   timestamp(30)     NULL,
    name         varchar(255)      NULL,
...
(
    ...
    created_by     int8         NULL,
    participant_id int8         NULL,
    shares_file_id int8         NULL,
    pool_id        int8         NULL,
    CONSTRAINT shares_pkey PRIMARY KEY (id),
    CONSTRAINT fk_shares_account_id FOREIGN KEY (created_by) REFERENCES public.accounts (id),
    CONSTRAINT fk_participant_id FOREIGN KEY (participant_id) REFERENCES public.participants (id),
    CONSTRAINT fk_shares_files_id FOREIGN KEY (shares_file_id) REFERENCES public.shares_files (id),
    CONSTRAINT fk_shares_pool_id FOREIGN KEY (pool_id) REFERENCES public.pools (id)
);
