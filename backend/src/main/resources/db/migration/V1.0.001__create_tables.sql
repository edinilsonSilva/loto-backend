...
CREATE TABLE IF NOT EXISTS drawn_numbers_in_order (
                                                      id SERIAL NOT NULL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS second_draw_numbers (
                                                   id SERIAL NOT NULL PRIMARY KEY,
                                                   lottery_draw_id BIGINT,
                                                   number VARCHAR(10),
    FOREIGN KEY (lottery_draw_id) REFERENCES lottery_draw(id) ON DELETE CASCADE
...
CREATE TABLE pools (
    ...
    -- Definindo a chave estrangeira que referencia a tabela 'accounts'
       CONSTRAINT fk_pool_account FOREIGN KEY (created_by) REFERENCES accounts(id),
    -- Definindo a chave estrangeira que referencia a tabela 'lottery_draw'
       CONSTRAINT fk_pool_lottery_draw FOREIGN KEY (contest_id) REFERENCES lottery_draw(id)
);
